...
import { Card, CardContent } from '../../components/vibe-kanban/ui/card';
...
import { projectsApi, tasksApi, templatesApi } from '../../lib/vibe-kanban/api';
import { TaskFormDialog } from '../../components/vibe-kanban/tasks/TaskFormDialog';
...
} from '../../components/vibe-kanban/ui/dropdown-menu';
import {
  Dialog,
  DialogContent,
  DialogHeader,
  DialogTitle,
  DialogFooter,
} from '../../components/vibe-kanban/ui/dialog';
...
import type { DragEndEvent } from '../../components/vibe-kanban/ui/shadcn-io/kanban';
...
export function ProjectTasks() {
  ...
  const handleCreateTask = useCallback(
    async (title: string, description: string) => {
      try {
        ...
        navigate(`/vibe-kanban/projects/${projectId}/tasks/${createdTask.id}`, {
          replace: true,
        });
      } catch (err) {
  ...
  const handleViewTaskDetails = useCallback(
    (task: Task) => {
      ...
      navigate(`/vibe-kanban/projects/${projectId}/tasks/${task.id}`, { replace: true });
    },
    [projectId, navigate]
  );
  ...
  const handleClosePanel = useCallback(() => {
    ...
    navigate(`/vibe-kanban/projects/${projectId}/tasks`, { replace: true });
  }, [projectId, navigate]);
  ...
  useKeyboardShortcuts({
    navigate,
    currentPath: `/vibe-kanban/projects/${projectId}/tasks`,
    hasOpenDialog:
