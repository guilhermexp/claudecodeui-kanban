...
export default function PromptsModal({ isOpen, onClose, onExecutePrompt }) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-[95vw] sm:max-w-5xl h-[75vh] sm:h-[70vh] min-h-[420px] p-0 bg-card border border-border mx-2 sm:mx-auto overflow-hidden rounded-2xl">
