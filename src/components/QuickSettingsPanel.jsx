...
const QuickSettingsPanel = ({ 
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-64 bg-white dark:bg-black border-l border-gray-200 dark:border-gray-800 shadow-xl transform transition-transform duration-150 ease-out z-40 ${
        ...
        <div className="h-full flex flex-col">
          ...
          <div className={`flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-6 ${isMobile ? 'pb-20' : ''}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center justify-between p-3 rounded-lg bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800 cursor-pointer transition-colors border border-gray-200 dark:border-gray-700">
                <span className="flex items-center gap-2 text-sm text-gray-900 dark:text-white">
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 rounded-lg bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-700">
