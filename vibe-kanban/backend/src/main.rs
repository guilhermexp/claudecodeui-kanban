...
fn main() -> anyhow::Result<()> {
    ...
    tokio::runtime::Builder::new_multi_thread()
        ...
        .block_on(async {
            ...
            // Only open browser if not disabled and not in debug mode
            let no_browser = std::env::var("VIBE_NO_BROWSER").is_ok();
            if !cfg!(debug_assertions) && !no_browser {
                ...
                tracing::info!("Browser opening disabled (VIBE_NO_BROWSER set)");
            }
